...
Recently I found the call of William Louth for a "self-adaptive manifesto" footnote:[http://www.infoq.com/news/2013/08/reactive-programming-emerging] which made me start thinking.
